...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: (Fail)People with 0 turns are incorrectly removed from the queue after their first turn.
    ...
    // Defect(s) Found: (Fail)People with negative turns are incorrectly removed from the queue after their first turn.
